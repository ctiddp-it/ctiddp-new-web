    ...
    <>
      ...
      <nav className={`sticky top-0 z-[1000] flex items-center justify-between px-4 lg:px-13 h-[78px] bg-[var(--overlay-nav)] backdrop-blur-xl border-b border-[rgba(37,99,235,0.1)] transition-shadow duration-300${scrolled ? ' shadow-[0_4px_40px_var(--shadow-scroll)]' : ''}`}>
        ...
        <div className="hidden lg:flex items-center gap-2 shrink-0">
          <a onClick={handleWhatsAppClick} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 border border-[rgba(74,222,128,0.35)] text-green  py-2 px-4 rounded-sm text-[11px] font-medium no-underline tracking-[0.3px] transition-all duration-200 whitespace-nowrap cursor-none hover:bg-[rgba(74,222,128,0.07)] hover:border-[rgba(74,222,128,0.6)]">
      ...
      >
        ...
        <div className="shrink-0 p-5 border-t border-[rgba(37,99,235,0.1)] flex flex-col gap-3">
          ...
          <a onClick={handleWhatsAppClick} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[rgba(37,211,102,0.07)] border border-[rgba(37,211,102,0.3)] text-green py-3 px-8 rounded-sm text-xs font-medium no-underline transition-all duration-200 cursor-none text-center">
