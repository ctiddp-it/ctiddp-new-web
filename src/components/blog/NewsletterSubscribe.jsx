            ...
            <form onSubmit={handleSubscribe} noValidate>
                <div className="relative">
                    <input
                        ...
                        className={`w-full rounded-lg py-2.5 px-3 text-sm outline-none transition-all placeholder:text-gray-400 disabled:bg-gray-100 disabled:cursor-not-allowed ${error
