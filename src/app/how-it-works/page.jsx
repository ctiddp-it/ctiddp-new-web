...
function StepItem({ s }) {
  return (
    <div className="reveal flex gap-4 items-start py-5 px-5 border-b border-[rgba(37,99,235,0.08)] last:border-0 hover:bg-[rgba(37,99,235,0.02)] transition-colors">
      <div className="font-['Cormorant_Garamond',serif] text-[32px] font-light text-[rgba(37,99,235,0.35)] leading-none shrink-0">
        {s.n}
      </div>
      <div className="flex-1">
        ...
        <span className="inline-block mt-2.5 text-[9px] font-semibold tracking-[1px] uppercase text-gold bg-[rgba(37,99,235,0.08)] py-1 px-2.5 rounded-sm">
          {s.tag}
        </span>
      </div>
    </div>
    ...
    <>
      ...
      <main className="bg-black text-white font-['Outfit',sans-serif]">
        ...
        <div className="flex items-center gap-[7px] px-4 sm:px-[60px] py-[11px] bg-[rgba(37,99,235,0.03)] border-b border-[rgba(37,99,235,0.07)] overflow-x-auto">
          ...
          <span className="text-[11px] text-gold-light whitespace-nowrap">How It Works</span>
        </div>
        ...
        <section className="relative overflow-hidden flex items-center justify-center text-center min-h-[45vh] px-4 sm:px-[60px] pt-[60px] sm:pt-[80px] pb-[60px] sm:pb-[80px] bg-black">
          ...
          <div className="relative z-10 max-w-[800px]">
            ...
            <h1 className="font-['Cormorant_Garamond',serif] text-[clamp(36px,5vw,65px)] font-light leading-[1.1] mb-4">
              One Contract.<br />
        ...
        <section className="px-4 sm:px-[60px] py-[60px] sm:py-[80px] bg-deep">
          <div className="max-w-[1200px] mx-auto">
            <div className="text-center mb-8">
              <span className="inline-flex items-center gap-1.5 bg-[rgba(37,99,235,0.1)] border border-[rgba(37,99,235,0.2)] text-gold-light text-[10px] font-semibold tracking-[1.5px] uppercase px-3 py-1 rounded-[3px]">
                ...
                {PROCESS_MAP.map((step, i) => (
                  <div key={step.label} className="flex items-center">
                    <div className="flex flex-col items-center text-center min-w-[90px] sm:min-w-[110px] px-1 sm:px-2">
                      <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full border border-[rgba(37,99,235,0.35)] bg-[rgba(37,99,235,0.08)] flex items-center justify-center text-gold-light text-[22px] transition-all duration-300 hover:scale-105 hover:border-[rgba(37,99,235,0.6)]">
                        {step.icon}
                      </div>
            ...
            <div className="text-center mt-6">
              <span className="inline-flex items-center gap-2.5 bg-[rgba(37,99,235,0.07)] border border-[rgba(37,99,235,0.15)] py-2.5 px-5 sm:py-3 sm:px-[22px] rounded-[3px] text-[12px] sm:text-[13px] text-muted">                
                <HiOutlineCalendarDays className="text-gold-light mt-[2px] shrink-0" size={22} />
                Total: <strong className="text-gold-light text-sm sm:text-base">38–50 days</strong> factory pickup to India warehouse
              </span>
            </div>
          </div>
        </section>
        ...
        <section className="px-4 sm:px-[60px] py-[60px] sm:py-[80px] bg-black">
          <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div>
              ...
              <h2 className="font-['Cormorant_Garamond',serif] text-[32px] sm:text-[38px] font-light text-white leading-[1.2] mb-6">
                From Factory<br />
                <em className="italic text-gold-light">To Port</em>
              </h2>
            ...
            <div>
              ...
              <h2 className="font-['Cormorant_Garamond',serif] text-[32px] sm:text-[38px] font-light text-white leading-[1.2] mb-6">
                From Port<br />
                <em className="italic text-gold-light">To Door</em>
              </h2>
              <div className="bg-[var(--overlay-card)] border border-[rgba(37,99,235,0.1)] rounded-[4px] overflow-hidden">
          ...
          <div className="max-w-[1200px] mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="font-['Cormorant_Garamond',serif] text-[clamp(32px,4vw,52px)] font-light leading-[1.1]">
                How Long Does<br />
                <em className="italic text-gold-light">It Take?</em>
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="reveal bg-[var(--overlay-input)] border border-[var(--overlay-card-border)] rounded-[4px] p-6 sm:p-[34px] hover:border-[rgba(37,99,235,0.2)] transition-all">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="font-['Cormorant_Garamond',serif] text-2xl font-semibold text-white">Sea Freight</span>
                </div>
                ...
                <div className="mt-5 pt-4 border-t border-[rgba(37,99,235,0.15)]">
                  <div className="flex items-baseline justify-between">
                    ...
                    <div className="text-right">
                      <span className="font-['Cormorant_Garamond',serif] text-[32px] font-semibold text-gold-light">38–50</span>
              ...
              <div className="reveal bg-[var(--overlay-input)] border border-[var(--overlay-card-border)] rounded-[4px] p-6 sm:p-[34px] hover:border-[rgba(37,99,235,0.2)] transition-all">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="font-['Cormorant_Garamond',serif] text-2xl font-semibold text-white">Air Freight</span>
                </div>
                <div className="space-y-0">
                  {[
                ...
                <div className="mt-5 pt-4 border-t border-[rgba(37,99,235,0.15)]">
                  <div className="flex items-baseline justify-between">
                    <span className="text-xs text-muted">Total Door-to-Door</span>
                    <div className="text-right">
                      <span className="font-['Cormorant_Garamond',serif] text-[32px] font-semibold text-gold-light">5–9</span>
                      <span className="text-xs text-muted ml-1">days</span>
                    </div>
                  </div>
                </div>
        ...
        {/* CTA Banner */}
        <div className="relative text-center px-4 sm:px-[60px] py-12 sm:py-16 overflow-hidden bg-gradient-to-br from-[rgba(37,99,235,0.12)] to-[rgba(37,99,235,0.05)] border-y border-[rgba(37,99,235,0.15)]">
          <h2 className="font-['Cormorant_Garamond',serif] text-[clamp(28px,3.5vw,44px)] text-white leading-[1.2] mb-3">
            Understand It.<br />
            <em className="italic text-gold-light">Then Let Us Handle It.</em>
          </h2>
