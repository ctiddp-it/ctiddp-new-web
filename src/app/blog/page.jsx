    ...
    <>
      ...
      <main className="bg-black text-white font-['Outfit',sans-serif]">
        ...
        <div className="flex items-center gap-[7px] px-4 sm:px-[60px] py-[11px] bg-[rgba(37,99,235,0.03)] border-b border-[rgba(37,99,235,0.07)] overflow-x-auto">
          ...
          <span className="text-[11px] text-gold-light whitespace-nowrap">Insights</span>
        </div>
            ...
            <div className="mb-12">
              ...
              <div className="reveal bg-[var(--overlay-card)] border border-[rgba(37,99,235,0.2)] p-8 sm:p-9 rounded-[4px] relative overflow-hidden hover:border-[rgba(37,99,235,0.4)] transition-all">
                ...
                <div className="flex flex-wrap gap-3 items-center mb-4">
                  <span className="text-[9px] tracking-[1.5px] uppercase py-1 px-2.5 rounded-full bg-[rgba(37,99,235,0.15)] text-gold-light border border-[rgba(37,99,235,0.2)]">
                    {POSTS[0].category}
                  </span>
                  <span className="text-[10px] text-muted">{POSTS[0].date}</span>
                </div>
                <h2 className="font-['Cormorant_Garamond',serif] text-[clamp(22px,2.8vw,34px)] font-semibold leading-tight mb-3.5 text-white">
                  {POSTS[0].title}
                </h2>
                ...
                <Link key={post.slug} href={`/insights/${post.slug}`} className="no-underline group">
                  <div className="reveal bg-[var(--overlay-card)] border border-border rounded-[4px] overflow-hidden transition-all duration-300 hover:border-[rgba(37,99,235,0.4)] hover:-translate-y-1">
                    <div className="h-40 bg-[rgba(37,99,235,0.05)] flex items-center justify-center relative">
                      <span className="text-[9px] tracking-[1.5px] uppercase text-gold bg-[rgba(37,99,235,0.12)] py-1 px-2.5 rounded-sm absolute top-3 left-3">
                        {post.category}
                      </span>
                    ...
                    <div className="p-5">
                      ...
                      <h3 className="font-['Cormorant_Garamond',serif] text-[17px] font-semibold text-white leading-tight mb-2 group-hover:text-gold-light transition-colors line-clamp-2">
                        {post.title}
                      </h3>
                      <p className="text-xs text-muted leading-relaxed mb-3 line-clamp-2">{post.excerpt}</p>
                      <div className="text-xs text-gold-light group-hover:underline">Read article →</div>
                    </div>
                  </div>
                </Link>
              ))}
        ...
        <section className="px-4 sm:px-6 lg:px-[60px] py-[60px] sm:py-[80px] bg-black">
          <div className="max-w-[560px] mx-auto text-center">
            ...
            <h2 className="font-['Cormorant_Garamond',serif] text-[clamp(32px,4vw,52px)] font-light leading-[1.1]">
              Duty Updates &<br />
              <em className="italic text-gold-light">Import Intelligence</em>
            </h2>
