    ...
    <>
      ...
      <main className="bg-black text-white font-['Outfit',sans-serif]">
        ...
        <div className="flex items-center gap-[7px] px-4 sm:px-[60px] py-[11px] bg-[rgba(37,99,235,0.03)] border-b border-[rgba(37,99,235,0.07)] overflow-x-auto">
          ...
          <span className="text-[11px] text-gold-light whitespace-nowrap">Canton Fair</span>
        </div>
        ...
        <section className="relative overflow-hidden flex items-center justify-center text-center min-h-[38vh] px-4 sm:px-[60px] pt-[60px] sm:pt-[90px] pb-[40px] sm:pb-[60px] bg-black">
          ...
          <div className="relative z-10 max-w-[740px]">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 bg-[rgba(37,99,235,0.1)] border border-border text-gold-light text-[11px] font-medium tracking-[2px] uppercase px-5 py-2 rounded-full mb-7 opacity-100">
        ...
        <section className="px-4 sm:px-[60px] py-[60px] sm:py-[90px] bg-deep">
          <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-[40px] sm:gap-[52px] items-start">
            ...
            <div>
              ...
              <h2 className="font-['Cormorant_Garamond',serif] text-[clamp(30px,4vw,56px)] font-light leading-[1.1] mb-[14px]">
                We Go to the Fair.<br />
                <em className="italic text-gold-light">You Get the Goods.</em>
              </h2>
            ...
            <div className="bg-[var(--overlay-input)] border border-border rounded-[4px] p-5 sm:p-7">
              <h4 className="font-['Cormorant_Garamond',serif] text-[20px] font-semibold mb-5 text-gold-light">
              ...
              <div className="mb-1.5">
                <div className="flex justify-between items-center py-2 border-b border-[rgba(37,99,235,0.1)] mb-1">
                  ...
                  <span className="text-[12px] text-gold-light">April 15 – May 5, 2026</span>
                </div>
              ...
              <div className="border-t border-[rgba(37,99,235,0.15)] pt-3 mt-2">
                <div className="flex justify-between items-center py-1">
                  ...
                  <span className="text-[12px] text-gold-light">Oct 15 – Nov 4, 2026</span>
                </div>
              </div>

              {/* Alert box */}
              <div className="bg-[rgba(37,99,235,0.07)] border border-[rgba(37,99,235,0.15)] p-[14px] rounded-[3px] my-[18px]">
                <div className="text-[10px] text-gold font-semibold tracking-[1px] uppercase mb-[5px]">
                  ⚡ Limited Spots
                </div>
        ...
        <section className="px-4 sm:px-[60px] py-[60px] sm:py-[90px] bg-black">
          <div className="max-w-[1200px] mx-auto">
            <div className="text-center mb-11">
              ...
              <h2 className="font-['Cormorant_Garamond',serif] text-[clamp(30px,4vw,56px)] font-light leading-[1.1] mb-[14px]">
                Who This Is<br />
                <em className="italic text-gold-light">For</em>
              </h2>
              <p className="text-[15px] text-muted max-w-[500px] mx-auto px-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                >
                  ...
                  <h4 className="font-['Cormorant_Garamond',serif] text-[16px] font-semibold mb-2 text-white">
                    {item.title}
                  </h4>
        ...
        <section className="px-4 sm:px-[60px] py-[60px] sm:py-[90px] bg-deep">
          <div className="max-w-[1200px] mx-auto">
            <div className="text-center mb-11">
              ...
              <h2 className="font-['Cormorant_Garamond',serif] text-[clamp(30px,4vw,56px)] font-light leading-[1.1] mb-[14px]">
                With & Without<br />
                <em className="italic text-gold-light">CTIDDP Support</em>
              </h2>
            </div>
        ...
        <section className="px-4 sm:px-[60px] py-[60px] sm:py-[90px] bg-black">
          <div className="max-w-[1200px] mx-auto">
            <div className="text-center mb-11">
              ...
              <h2 className="font-['Cormorant_Garamond',serif] text-[clamp(30px,4vw,56px)] font-light leading-[1.1] mb-[14px]">
                Full Canton Fair<br />
                <em className="italic text-gold-light">Service Scope</em>
              </h2>
            </div>
        ...
        <section className="px-4 sm:px-[60px] py-[60px] sm:py-[90px] bg-deep">
          <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-[48px] sm:gap-[72px] items-start">
            ...
            <div>
              ...
              <h2 className="font-['Cormorant_Garamond',serif] text-[clamp(30px,4vw,56px)] font-light leading-[1.1] mb-[14px]">
                Year-Round<br />
                <em className="italic text-gold-light">Sourcing Support</em>
              </h2>
            ...
            <div className="bg-surface border border-[rgba(37,99,235,0.15)] p-6 sm:p-8 rounded-[3px]">
              <h3 className="font-['Cormorant_Garamond',serif] text-[22px] font-semibold mb-4 text-gold-light">
